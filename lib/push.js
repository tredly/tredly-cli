...
module.exports = function* (serverPath, partition, options) {
    ...
    return yield new Promise (function (resolve, reject) {
        ...
        if (!_.find(files, function (file) { return file.name === 'Tredlyfile'; })) {
        ...
        var stream = request({
            url: url.resolve(apiUrl, '/tredly/v1/push/container'),
            method: 'POST',
            strictSSL: false,
            headers: {
